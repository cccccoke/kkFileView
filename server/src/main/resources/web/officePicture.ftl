...
<#if "false" == switchDisabled>
    <img src="images/pdf.svg" width="28" height="28" style="position: fixed; cursor: pointer; top: 40%; right: 28px; z-index: 999;" alt="使用PDF预览" title="使用PDF预览" onclick="changePreviewType('pdf')"/>
</#if>
<script>
