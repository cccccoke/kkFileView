...
<#if "false" == switchDisabled>
    <img src="images/jpg.svg" width="20" height="20" style="position: fixed; cursor: pointer; top: 90%; right: 18px; z-index: 999;" alt="使用图片预览" title="使用图片预览" onclick="goForImage()"/>
</#if>
</body>
